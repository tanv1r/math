...
\begin{enumerate}
	...
	\begin{equation*}
		...
		\end{aligned}
	\end{equation*}
We are now back to the first case where we have two non-negative numbers $a'_1a'_2$ and $a'_3$ and they sum to 2. So, we know how to go about the proof henceforth.
