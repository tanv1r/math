...
\hline
$\xmark$ & $\cmark$ & $\xmark$ & 2, $\left( x = \pm \gamma^{\frac{1}{8}} \mbox{ with } \gamma = -\frac{c}{a} > 0 \right)$\\
\hline
$\xmark$ & $\xmark$ & $\cmark$ & 3, $\left( x=0, \pm \delta^{\frac{1}{4}} \mbox{ with } \delta = -\frac{b}{a} > 0 \right)$\\
\hline
$\xmark$ & $\xmark$ & $\xmark$ & \shortstack{4, two come from each of the two solutions of \\ $ay^2 + ay+c = 0$ with $y = x^4$}\\
\hline %inserts single line
\end{tabular}
\end{table}
