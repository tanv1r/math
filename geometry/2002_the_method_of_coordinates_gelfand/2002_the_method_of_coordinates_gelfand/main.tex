...
\begin{enumerate}
	\item $A(x_1)$ is to the left of $B(x_2)$. Here we have three different sub-cases.\footnote{\begin{tikzpicture}[scale=0.5]
...
\end{tikzpicture}}\footnote{\begin{tikzpicture}[scale=0.5]
...
\end{tikzpicture}} For all three sub-cases we have:
\[
	x = x_1 + \frac{x_2 - x_1}{2} = \frac{x_1 + x_2}{2}
\]
\break
\item $B(x_2)$ is to the left of $A(x_1)$. Again, we have three sub-cases.\footnote{\begin{tikzpicture}[scale=0.5]
...
\end{tikzpicture}} For these three sub-cases, we have:
\[
	x = x_2 + \frac{x_1 - x_2}{2} = \frac{x_1 + x_2}{2}
\]
\end{enumerate}
\break
