...
\newthought{On a number axis} two points $A(x_1)$ and $B(x_2)$ are given. Find the cooridinate of the center of the segment $AB$.

\newthought{Let} $C(x)$ be the center. We can find $x$ by adding half of the distance between $A(x_1)$ and $B(x_2)$, therefore $\frac{1}{2}d(A, B)$, to the smaller of $x_1$ and $x_2$.
\[
x = 
\begin{cases} 
